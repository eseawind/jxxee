...
public class ReportHtmlFormGrid extends ReportHtml {
	...
	private String fillSubArea(String jsTblObj, Map<String, String> mpData) throws ReportException {
		...
		Map<String, List<Map<String,String>>> mpSubRecord = 
			ReportXlsFormGrid.getSubRecord(pkval, strPKCol, _lsSubArea);
		int maxPage = ReportXlsFormGrid.getMaxPageBySubRecord(mpSubRecord, _lsSubArea);
	...
	//修改报表输出模板
	private boolean insertTableRow(StringBuilder sbRet, 
