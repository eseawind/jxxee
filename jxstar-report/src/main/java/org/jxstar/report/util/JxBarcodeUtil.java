...
/**
 * 条码处理相关工具类。
 * 支持的条码标准格式有：pdf417, upc-a, upc-e, ean-13, intl2of5, itf-14, code39, datamatrix, 
 * codabar, usps4cb, royal-mail-cbc, postnet, code128, ean-128, ean-8, 
 *
 * @author TonyTan
       ...
       try {
            ...
            try {
                BitmapCanvasProvider canvas = new BitmapCanvasProvider(
                        out, "image/png", _resolution, BufferedImage.TYPE_BYTE_BINARY, false, 0);
