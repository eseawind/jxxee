Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'任务名称', width:260, sortable:true}, field:{name:'wf_process__process_name',type:'string'}},
	...
	{col:{header:'功能ID', width:100, sortable:true, hidden:true}, field:{name:'wf_assignhis__fun_id',type:'string'}}
	];
