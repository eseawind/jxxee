		...
		items:[{
			...
			items:[{
				...
				items:[
					...
					{xtype:'textfield', fieldLabel:'关键表', name:'rpt_area__main_table', anchor:'100%', maxLength:50},
					...
					{xtype:'checkbox', fieldLabel:'是否输出合计', name:'rpt_area__has_sum', defaultval:'0', disabled:false, anchor:'100%'},
