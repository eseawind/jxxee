	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				items:[
					{xtype:'numberfield', allowDecimals:false, fieldLabel:'序号', name:'rpt_area__area_index', anchor:'67%', maxLength:12},
			...
			items:[{
				...
				items:[
					...
					{xtype:'hidden', fieldLabel:'表名', name:'rpt_area__main_table', anchor:'100%'},
