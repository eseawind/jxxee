		...
		items:[{
			...
			items:[{
				...
				items:[
					...
					{xtype:'hidden', fieldLabel:'信息类型', name:'sys_news__cont_type', defaultval:'1', anchor:'100%'}
				]
			},{
				border:false,
				columnWidth:0.495,
			...
			items:[{
				...
				items:[
					...
					{xtype:'textarea', fieldLabel:'公告内容', name:'sys_news__news_cont', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', width:'100%', height:312, maxLength:4000}
				]
			}
			]
		}]
