Jxstar.currentPage = function() {
	...
	{col:{header:'编号', width:100, sortable:true}, field:{name:'sys_news__news_code',type:'string'}},
	{col:{header:'新闻公告标题', width:303, sortable:true}, field:{name:'sys_news__news_title',type:'string'}},
	{col:{header:'新闻公告标内容', width:100, sortable:true, hidden:true}, field:{name:'sys_news__news_cont',type:'string'}},
